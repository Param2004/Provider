...
function CallScheduler({onStateChange}) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-white p-6 rounded-lg shadow-lg max-h-[90vh] w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] overflow-y-auto"
            ...
            <div className="bg-gray-50 text-gray-800 p-4 flex justify-center">
              <div className="bg-white rounded-xl shadow-md p-4">
                <div className="space-y-4">
                  ...
                  {/* Submit button */}
                  <div className="pt-4">
                    <button onClick={handleSubmit} className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-4 rounded-lg transition-colors">
                      Schedule Call
                    </button>
                  </div>
                </div>
              ...
              <div>
                <X onClick={closePopup} className="h-6 w-6" />
              </div>
            </div>
          )}
        </motion.div>
